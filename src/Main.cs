...
class Options
{
	...
	[Option("config_dir", Default = "D:\\itm\\devs\\itm-smart-projects\\face-sdk\\conf\\facerec", HelpText = "Path to config directory.")]
	public string config_dir { get; set; }

	//[Option("license_dir", Default = null, HelpText = "Path to license directory [optional].")]
	[Option("license_dir", Default = null, HelpText = "D:\\itm\\devs\\itm-smart-projects\face-sdk\\license")]
	public string license_dir { get; set; }

	//[Option("database_dir", Default = "../../base", HelpText = "Path to database directory.")]
	[Option("database_dir", Default = "D:\\itm\\devs\\itm-smart-projects\\face-sdk\\bin\\base", HelpText = "Path to database directory.")]
